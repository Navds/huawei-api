...
$(document).ready(function() {
    ...
    if (getQueryStringByName('mode') != null)
    {
        if (getQueryStringByName('mode').toLowerCase() == 'local' && g_feature.special_debug_page == 1)
        {
            $('#online_update').hide();
    ...
    $('#update_now').live('click', update_onClickUpdateNow);
    ...
    if (getQueryStringByName('mode') == null || getQueryStringByName('mode').toLowerCase() != 'local' ||g_feature.special_debug_page != 1)
    {
