...
function createListForDevice(_name, _value) {
   ...
   if (tdName == '') {
    ...
    if (tdName == system_label_my_number || tdName == wlan_label_mac_address || tdName == IDS_common_mac_address_x.replace('%d', 1) || tdName == IDS_common_mac_address_x.replace('%d', 2))
    {
