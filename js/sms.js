                    ...
                    for(i = pb_start; i <= pb_end; i++) {
                        if('' != $(".sms_phone_number").eq(i).text()) {
                           if((i+1) > pb_end){
                            ...
                            $(".sms_phone_number").eq(i).html(pb_contactsName);
                            index++;
                        }
                    }
...
function sms_showWaitingDialog(tipTitle, tipContent, callback_func) {
    ...
    tipTitle +
	"</label><span class='wait_dialog_btn' id='wait_dialog_btn' ><img src='" + RES_PATH + "dialog_close_btn.gif' alt='' /></span></td></tr>" +
	"<tr><td class='wait_table_content'><div class='wait_wrapper'><div class='wait_image'><img src='" + RES_PATH + "waiting.gif' alt=''/></div><div class='wait_str'>" +
    tipContent +
    "</div></div></td>" +
    "</tr>" +
    "<tr>" +
...
function sms_showSmsDialog() {
	...
	dialogHtml += "            <span class='dialog_header_right'><a class='dialog_close_btn' title='' href='javascript:void(0);'><img src='" + SMS_CLOSE_BUTTON + "' title='' alt='' /></a></span>";
    dialogHtml += "        </div>";
                            ...
                            if(g_module.pb_enabled){
                                   ...
                                   var ret = xml2object($xml);
                                     if(ret.type == "response")
                                      {
                                        var contactsName = ret.response.Name;
                                         successDialogHtml += "<tr class='send_success_info'><td><table><tr><td rowspan='2' width='30' valign='top'><img src='" + RES_PATH + "icon_sms_send_success.gif' alt='' /></td>"+
                                         "<td>" + sms_label_the_message_sent_successed + common_colon +
                                         "</td></tr><tr><td class='success_phone_number'>" + contactsName.split(";").join("; ") + "</td></tr></table></td></tr><tr class='send_failed_info'><td height='21'></td></tr>";
                                ...
                                if(failedTotal >0) {
                                   ...
                                   if(ret.type == "response")
                                      {
                                        var contactsName = ret.response.Name;
                                     successDialogHtml += "<tr class='send_failed_info'><td><table><tr><td rowspan='2' width='30' valign='top'><img src='" + RES_PATH + "icon_sms_send_failed.gif' alt='' /></td>"+
                                     "<td>" + sms_label_the_message_sent_failed + common_colon +
                                     "</td></tr><tr><td  class='failed_phone_number'>" + contactsName.split(";").join("; ") + "</td></tr></table></td></tr>";
                                    g_sendSuccessAndFailedFlag = true;
                                     }
                                   }, {
                                    sync : true
