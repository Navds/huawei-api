...
function redirectOnCondition(prefix, postfix) {
    ...
    var index = cur_href.indexOf("home.html");
    /* expect the case "home.html#" */
    if ( (cur_href.length - index) < 11)
    {
        return;
    }
